...
CREATE TABLE BUSINESS_APPLICANT_INTERVIEW(
       AI_NUM NUMBER  NOT NULL PRIMARY KEY
     , USER_ID VARCHAR2(20) NOT NULL
     , USER_NAME VARCHAR2(50) NOT NULL
     , INTERVIEW_TIME TIMESTAMP NOT NULL
     , INTERVIEW_LOCATION VARCHAR2(1000) NOT NULL
     , INTERVIEWER VARCHAR2(100) 
     , ALARM_TYPE VARCHAR2(10) NOT NULL
     , ATTEND_TYPE VARCHAR2(1) NOT NULL
...
CREATE TABLE BUSINESS_APPLICANT(
     ...
     , RESULT_TITLE VARCHAR2(100)
     , RESULT_CONTENT VARCHAR2(2000)
