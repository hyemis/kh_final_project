                ...
                <div class="container bg-white p-5">
                    ...
                    <div class="num-container row" id="num-container">
                        <div class="col num-item">
                            ...
                            <span class="nums" data-count="${totalCount }">0</span>
                            <span id="num-unit">개</span><br>
                        </div>
                    </div>
                    <hr>
                    <div class="s">
                    ...
                    <ul class="pagination text-center justify-content-center">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li class="page-item">
                                    <a class="page-link" href="${pageContext.request.contextPath}/board/postall?pnum=${boardList.nextPage}&cate=${categoryId}">next</a>
                                </li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
