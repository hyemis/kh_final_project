...
<form action="update" method="post">
	...
	<input name="passwd" value="${PsUserDto.userPw }" type="password"  placeholder="pass"><br>
	<input name="name" value="${PsUserDto.userName }"  type="text" readonly="readonly"><br>
	<input name="email" value="${PsUserDto.userEmail }" type="text" placeholder="email"><br>
